...
public class faturamodel extends AbstractTableModel {
    ...
    public faturamodel(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"Fatura No","Kesim Tarihi","Tutarı","İsim"};
    @Override
