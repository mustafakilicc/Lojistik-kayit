...
public class muayenemodel extends AbstractTableModel {
    ...
    private ArrayList veriler = new ArrayList();
       ...
       public muayenemodel(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"Plaka","Muayene Tarihi","Kalan Gün"};
    @Override
