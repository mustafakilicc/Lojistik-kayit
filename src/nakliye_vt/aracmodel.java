...
public class aracmodel extends AbstractTableModel {
    ...
    public aracmodel(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"plaka","muayene tarihi","Şoför"};
    @Override
