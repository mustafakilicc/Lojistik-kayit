...
public class numara_model extends AbstractTableModel {
    ...
    private ArrayList veriler = new ArrayList();
       ...
       public numara_model(ResultSet rs) throws SQLException {
    ...
    public String[] sutunIsimleri = {"TC Kimlik","İsim","Telefon"};
    @Override
